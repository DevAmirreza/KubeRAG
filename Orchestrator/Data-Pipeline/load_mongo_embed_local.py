...
llm = AzureOpenAI(
    ...
    deployment_name=os.getenv("AZURE_LLM_MODEL_EMBED_DEPLOYMENT"),
...
def load_index(path):
    ...
    documents = SimpleDirectoryReader(DATA_PATH_IND, errors="ignore").load_data()
    ...
    store = MongoDBAtlasVectorSearch(
        ...
        collection_name=os.getenv("MONGODB_COLLECTION"), # this is where your embeddings will be stored
...
t1 = threading.Thread(target=load_index, args=("/",))
